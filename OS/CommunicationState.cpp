...
void CommunicationState::initButtons()
{
	...
	this->buttons["SHOWMESSAGE"] = new Button(630, 350, 244, 44, &this->font, "Show messages");
...
CommunicationState::CommunicationState(sf::RenderWindow *window, std::stack<GUIState*> *states, sf::Event *event)
